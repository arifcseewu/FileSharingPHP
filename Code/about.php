...
<div id="contact" class="container-fluid bg-grey" style="background:white;color:black;padding-top:5px;">
  <h2 class="text-center"><br>About Us</h2>
  <p class="text-center"> This is a non-commercial website created for educational purpose. This website is developed by Tanzim Rizwan & Nabil Shawkat.
  <center><hr style="width:20%;padding-top: 0;margin-top: 0;"></center>
  <br>
  <div class="row">
    <div class="col-sm-5 text-center">
      <p><b>Name: Nabil Shawkat</b></p>
      <p>ID: 2013-1-60-023</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> Khilgaon, Dhaka</p>
      <p><span class="glyphicon glyphicon-phone"></span> 01616058666</p>
      <p><span class="glyphicon glyphicon-envelope"></span> nabil.shawkat023@gmail.com</p>
      
    </div>
    <div class="col-sm-7 slideanim text-center">
       <p><b>Name: Tanzim Rizwan</b></p>
      <p>ID: 2013-1-60-063</p>
      <p><span class="glyphicon glyphicon-map-marker"></span> Banasree, Dhaka</p>
      <p><span class="glyphicon glyphicon-phone"></span> 01811266324</p>
      <p><span class="glyphicon glyphicon-envelope"></span> tanzimrizwan@gmail.com</p>
    </div>
  </div>
   <div class="row" class="col-sm-3" style="margin:40px 0px 30px 0px;">
          <div class="col-sm-5 text-center">
            <ul class="list-unstyled list-inline socialul">
              <li class="customcolor">Follow on :</li>
              <li><a href="https://plus.google.com/u/0/113374462056145730094/posts" class="customcolor"><img src="http://www.stamgent.be/userfiles/images/logo/GooglePlusLogo.png" style="width:40px;
      height:40px;"></a></li>
              <li><a href="https://www.facebook.com/nabilkun" class="customcolor"><img src="http://recoveringvoices.si.edu/images/facebook_icon.png" style="width:40px;
      height:40px;"></a></li>
          ...
          <div class="col-sm-7 text-center">
             <ul class="list-unstyled list-inline socialul">
              <li class="customcolor">Follow on :</li>
              <li><a href="hhttps://plus.google.com/102963687065965428699/posts" class="customcolor"><img src="http://www.stamgent.be/userfiles/images/logo/GooglePlusLogo.png" style="width:40px;
      height:40px;"></a></li>
              <li><a href="https://www.facebook.com/tanzim51?fref=ts" class="customcolor"><img src="http://recoveringvoices.si.edu/images/facebook_icon.png" style="width:40px;
      height:40px;"></a></li>
